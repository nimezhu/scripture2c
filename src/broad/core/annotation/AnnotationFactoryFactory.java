 ...
 *  Interface Demo:
 *  
 *  AnnotationFactory a = AnnotationFactoryFactory.getFactory("bed")
 *  Bed b = a.create(list);
 *  
 *  or
 *  
 *  Bed b = AnnotationFactoryFactory.getFactory("bed").create(list);
 *
 *  or
 *  
 *  Annotation b = AnnotationFactoryFactory.getFactory("bed").create(list);
 */
public class AnnotationFactoryFactory  {
	...
	public static Class StringToType(String annotationType)
	{
			...
			return ShortBED.class;
		} else if ("BEDGraph".equalsIgnoreCase(annotationType)) {
			return BEDGraph.class;
		} else {
			return BasicAnnotation.class;
		}
