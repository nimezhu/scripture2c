...
public class RepeatMaskerAnnotation extends BasicGenomicAnnotation {
	...
	public String toRepeatMaskString() {
		StringBuffer s= new StringBuffer("");
		s.append(this.bin).append("\t").
		append(getScore()).append("\t").append(this.mismatches).append("\t").append(this.deleted).append("\t")
		.append(this.inserted).append("\t").append(getChromosome()).append("\t").append(getStart()).append("\t")
		.append(getEnd()).append("\t").append(this.basesLeftAfterMatch)
		.append("\t").append(getOrientation())
		.append("\t").append(this.repName)
		.append("\t").append(this.repClass)
		.append("\t").append(this.repFamily)
		.append("\t").append(this.repStart)
		.append("\t").append(this.repEnd)
		.append("\t").append(this.repLeft);
		return s.toString();
	}
