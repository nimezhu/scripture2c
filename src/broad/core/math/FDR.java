...
public class FDR {
	...
	public static double computeFDR(EmpiricalDistribution observed, EmpiricalDistribution[] random, double k){
	...
	public static double computeFDR(Map<String, Double> observed, EmpiricalDistribution[] random, double k){
